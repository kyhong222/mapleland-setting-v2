...
export const SKILL_APM: Record<number, ApmSpec> = {
  ...
  // ── 해적 너클(인파이터) docs §12.5 ──
  5001001: { type: 'curve', apm: { 2: 130, 3: 114, 4: 108, 5: 104, 6: 101 } }, // 스트레이트
  15001001: { type: 'curve', apm: { 2: 130, 3: 114, 4: 108, 5: 104, 6: 101 } },
  5001002: { type: 'curve', apm: { 2: 89, 3: 84, 4: 77, 5: 72, 6: 69 } }, // 써머솔트 킥
  15001002: { type: 'curve', apm: { 2: 89, 3: 84, 4: 77, 5: 72, 6: 69 } },
  5101003: { type: 'curve', apm: { 2: 53, 3: 53, 4: 53, 5: 53, 6: 51 } }, // 더블 어퍼
  5111006: { type: 'curve', apm: { 2: 40, 3: 37, 4: 34, 5: 32, 6: 31 } }, // 쇼크웨이브
  15111003: { type: 'curve', apm: { 2: 40, 3: 37, 4: 34, 5: 32, 6: 31 } },
  5121004: { type: 'curve', apm: { 2: 26, 3: 24, 4: 22, 5: 21, 6: 20 } }, // 데몰리션
  // ── 해적 건(공란 = 해당 공속 건 없음 → 평타곡선 폴백) docs §12.5 ──
  5210000: { type: 'curve', apm: { 2: 91, 3: 87, 5: 74 } }, // 트리플 파이어
  5201004: { type: 'curve', apm: { 2: 91, 3: 87, 5: 74 } }, // 페이크 샷(=트리플파이어)
  5221007: { type: 'curve', apm: { 2: 100, 3: 96, 5: 80 } }, // 배틀쉽 캐논
  5221008: { type: 'curve', apm: { 2: 83, 3: 77, 5: 74 } }, // 배틀쉽 토르페도
  // ── 도적 표창(트리플스로우; 공란 = 해당 공속 무기 없음) docs §12.4 ──
  4121007: { type: 'curve', apm: { 2: 100, 3: 90, 4: 83, 6: 74 } }, // 트리플 스로우(나로)
  14111005: { type: 'curve', apm: { 2: 100, 3: 90, 4: 83, 6: 74 } }, // 트리플 스로우(나워)
}
...
export function attacksPerMinute(
  ...
  if (spec) {
    switch (spec.type) {
      ...
      case 'curve':
        // 미정의 단계(해당 무기에 없는 공속 = 표 공란)는 평타곡선으로 폴백
        return spec.apm[step] ?? BASIC_APM[step]
      case 'basic':
