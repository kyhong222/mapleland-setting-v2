...
const EXPECTED_DIVERGENCE = new Map([
  // 상류 prop이 5~150이라 20레벨에 이미 100%를 넘는다. 툴팁이 "#prop%의 확률로 블록"이므로
  // 성립 불가능한 값이라, 인게임 값(lv1~20 0.5씩 / lv21~30 1씩, lv30 = 20%)으로 고쳐 쓴다.
  [1120005, '상류 prop(5~150)이 확률로 성립 불가. 인게임 0.5~20% 사용'],
  [1220006, '상류 prop(5~150)이 확률로 성립 불가. 인게임 0.5~20% 사용'],
